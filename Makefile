...
REAL_DIRS := $(addprefix $(DESTDIR)/, .i3 .mutt .offlineimap .xmonad .vim .config/termite .config/dunst .config/autorandr .config/conky .config/qutebrowser .config/i3 .config/polybar .config/compton .local/bin .weechat)
