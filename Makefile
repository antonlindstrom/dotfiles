...
REAL_DIRS := $(addprefix $(DESTDIR)/, .i3 .mutt .offlineimap .vim/autoload .config/termite .config/dunst .config/autorandr .config/qutebrowser .config/systemd/user/default.target.wants .config/i3 .local/bin .tmux/plugins .weechat .config/fish .config/mpd/playlists .imapfilter)
